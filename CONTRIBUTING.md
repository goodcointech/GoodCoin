Contributing to GoodCoin Core
============================

The GoodCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GoodCoin Core project, and is not to be
confused with overall GoodCoin Network Protocol consensus changes.

Whether a pull request is merged into GoodCoin Core rests with the project merge
...
Patches that change GoodCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GoodCoin consensus, it must have been
...
The project leader is the release manager for each GoodCoin Core release.
