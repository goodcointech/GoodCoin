...
RESOURCES += src/qt/goodcoin.qrc src/qt/goodcoin_locale.qrc

TRANSLATIONS += src/qt/locale/goodcoin_bg.ts \
                src/qt/locale/goodcoin_de.ts \
                src/qt/locale/goodcoin_en.ts \
                src/qt/locale/goodcoin_es.ts \
                src/qt/locale/goodcoin_fi.ts \
                src/qt/locale/goodcoin_fr.ts \
                src/qt/locale/goodcoin_it.ts \
                src/qt/locale/goodcoin_ja.ts \
                src/qt/locale/goodcoin_pl.ts \
                src/qt/locale/goodcoin_pt.ts \
                src/qt/locale/goodcoin_ru.ts \
                src/qt/locale/goodcoin_sk.ts \
                src/qt/locale/goodcoin_sv.ts \
                src/qt/locale/goodcoin_vi.ts \
                src/qt/locale/goodcoin_zh_CN.ts \
                src/qt/locale/goodcoin_zh_TW.ts
