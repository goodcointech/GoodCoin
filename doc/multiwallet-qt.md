...
In order to support loading of multiple wallets in goodcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goodcoin.cpp.
...
Changes to goodcoin.cpp
----------------------
goodcoin.cpp is the entry point into goodcoin-qt, and as such, will require some minor modifications to provide hooks for
