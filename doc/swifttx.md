...
This mechanism has been integrated into Bitcore-Node-GoodCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GoodCoin-Project/insight-api-goodcoin#web-socket-api](https://github.com/GoodCoin-Project/insight-api-goodcoin#web-socket-api) 
* API: [https://github.com/GoodCoin-Project/insight-api-goodcoin#swifttx-transactions](https://github.com/GoodCoin-Project/insight-api-goodcoin#swifttx-transactions) 
...
By default, the GoodCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GoodCoin Core daemon:
