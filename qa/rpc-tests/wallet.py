...
#   c) node1 mines 32 blocks, so now node 0 has 60001gdc, node 1 has 4250gdc, node2 has none.
#   d) node0 sends 601 gdc to node2, in two transactions (301 gdc, then 300 gdc).
