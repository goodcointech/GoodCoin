...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GoodCoin Core goodcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  goodcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded goodcoin transaction") + "\n" +
                               "  goodcoin-tx [options] -create [commands]   " + _("Create hex-encoded goodcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded goodcoin transaction
