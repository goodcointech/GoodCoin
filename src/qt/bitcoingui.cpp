                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GoodCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GoodCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goodcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGDC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GoodCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoodCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoodCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GoodCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GoodCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a GoodCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoodCoin Core help message to get a list with possible GoodCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GoodCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("GoodCoin Core"); // default title
