...
/** Utility functions used by the GoodCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GoodCoin addresses in monospace font
...
// Parse "goodcoin:" URI into recipient object, return true on successful parsing
