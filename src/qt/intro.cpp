...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GoodCoin Core"),
     ...
     * override -datadir in the goodcoin.conf file in the default data directory
     * (to be consistent with goodcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
