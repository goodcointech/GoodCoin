...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zgdcTracker->HasMintTx(hash))) {
            //zGDC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZGDC;
...
bool IsZGDCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZGDC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZGDC || type == TransactionRecord::MNReward) {
