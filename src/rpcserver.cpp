...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GoodCoin features */
        {"goodcoin", "masternode", &masternode, true, true, false},
        {"goodcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"goodcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"goodcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"goodcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"goodcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"goodcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"goodcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"goodcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"goodcoin", "startmasternode", &startmasternode, true, true, false},
        {"goodcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"goodcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"goodcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"goodcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"goodcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"goodcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"goodcoin", "mnbudget", &mnbudget, true, true, false},
        {"goodcoin", "preparebudget", &preparebudget, true, true, false},
        {"goodcoin", "submitbudget", &submitbudget, true, true, false},
        {"goodcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"goodcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"goodcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"goodcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"goodcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"goodcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"goodcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"goodcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"goodcoin", "mnsync", &mnsync, true, true, false},
        {"goodcoin", "spork", &spork, true, true, false},
        {"goodcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgdcseed", &getzgdcseed, false, false, true},
        {"zerocoin", "setzgdcseed", &setzgdcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgdc", &searchdzgdc, false, false, true},
        {"zerocoin", "dzgdcstate", &dzgdcstate, false, false, true}
...
{
    return "> goodcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6199/\n";
}
