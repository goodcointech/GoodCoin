...
/**
 * GoodCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzgdcseed(const UniValue& params, bool fHelp);
extern UniValue getzgdcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgdc(const UniValue& params, bool fHelp);
extern UniValue dzgdcstate(const UniValue& params, bool fHelp);
