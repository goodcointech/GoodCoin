...
#ifndef GoodCoin_STAKEINPUT_H
#define GoodCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZGDC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zGDCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zgdc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZGDC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZGDC() override { return false; }
};


#endif //GoodCoin_STAKEINPUT_H
