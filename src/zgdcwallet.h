...
#ifndef GoodCoin_ZGDCWALLET_H
#define GoodCoin_ZGDCWALLET_H
...
public:
    CzGDCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGDC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGDC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //GoodCoin_ZGDCWALLET_H
